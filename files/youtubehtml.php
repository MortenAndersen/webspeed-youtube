...
$iframe_content = '<style>
        ...
        <a href="https://www.youtube.com/embed/' . get_field('youtube') . '?autoplay=1"><img src="https://i.ytimg.com/vi_webp/' . get_field('youtube') . '/maxresdefault.webp" alt="' . get_field('video_titel') . '" loading="lazy">
